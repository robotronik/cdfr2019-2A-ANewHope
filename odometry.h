...
#define timX_isr(void) tim1_brk_tim15_isr(void) //magic trick of timer 15 normaly timX_isr
#define ODOM_RCC_TIM RCC_TIM15
#define ODOM_NVIC_TIM_IRQ NVIC_TIM1_BRK_TIM15_IRQ //normaly NVIC_TIMx_IRQ
